...
if __name__ == '__main__':
    ...
    ax.arrow(0, 0, W[0, 0], W[0, 1], head_width=1.0, head_length=0.5, fc='k', ec='k')
    ax.annotate(r'$w_0$', xy=(1.0, 1.0), xycoords='data', xytext=(W[0, 0] + 0.5, W[0, 1] + 0.5), textcoords='data',
                size=20)

    ax.arrow(0, 0, W[1, 0], W[1, 1], head_width=1.0, head_length=0.5, fc='k', ec='k')
    ax.annotate(r'$w_1$', xy=(1.0, 1.0), xycoords='data', xytext=(W[1, 0] + 0.5, W[1, 1] + 1.0), textcoords='data',
                size=20)
    ...
    # Compute a normalization factor for the length of the components
    nf = np.sort(np.expand_dims(eigu / np.linalg.norm(eigu), axis=1))[::-1]
    W = W_sanger * (15 * nf)

    ax.arrow(0, 0, W[0, 0], W[0, 1], head_width=1.0, head_length=0.5, fc='k', ec='k')
    ax.annotate(r'$w_0$', xy=(1.0, 1.0), xycoords='data', xytext=(W[0, 0] + 1.0, W[0, 1]), textcoords='data',
                size=20)
